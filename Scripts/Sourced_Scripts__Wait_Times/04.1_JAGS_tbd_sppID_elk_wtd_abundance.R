  #'  ----------------------------------------
  #'  Wait time sppID + prey RIA (elk & wtd) model
  #'  
  ...
  #'  abundance of elk/wtd on the time that elapses before detecting a focal 
  #'  predator species.
  #'  -----------------------------------------
  
  cat(file = "./Outputs/tbd_sppID_elk_wtd_abundance.txt", "
      model{
