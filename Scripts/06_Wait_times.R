  ...
  #' load("./Data/All_Detections_Smr20.RData")
  #' load("./Data/All_Detections_Smr21.RData")
  #' 
  #' #'  Sequential problem images
  #' load("./Data/eoe20s_sequential_probimgs.RData")
  #' load("./Data/eoe21s_sequential_probimgs.RData")
  #' 
  #' #'  Load corrected species ID and update larger datasets
  #' newSppID <- read.csv("./Data/questionable_images_doublecheck_SBBupdated.csv") %>%
  ...
  #' newnewSppID <- read.csv("./Data/More questionable IDs_ST_SBB.csv") %>%
  ...
  #'   return(skinny_dets)
  #' }
  #' dets_smr20_skinny <- thin_detections(eoe20s_allM_new, eoe_seqprob_20s)
  #' dets_smr21_skinny <- thin_detections(eoe21s_allM_new, eoe_seqprob_21s)
  #' 
  ...
  #'   dets <- dets %>%
  #'     dplyr::select("NewLocationID", "File", "Date", "Time", "posix_date_time", 
  ...
  #'   return(dets)
  #' }
  #' dets_smr20 <- detections(dets_smr20_skinny, start_date = "2020-07-01", end_date = "2020-09-15")
  #' dets_smr21 <- detections(dets_smr21_skinny, start_date = "2021-07-01", end_date = "2021-09-15")
  #' 
  #' save(dets_smr20, file = "./Data/dets_smr20.RData")
  #' save(dets_smr21, file = "./Data/dets_smr21.RData")
