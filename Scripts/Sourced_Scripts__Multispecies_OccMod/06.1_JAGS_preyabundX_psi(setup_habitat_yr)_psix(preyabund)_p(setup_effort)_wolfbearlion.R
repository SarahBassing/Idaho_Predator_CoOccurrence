  #'  ------------------------------------
  #'  Prey relative abundance model with interaction
  ...
  #'  ------------------------------------
  #'  Includes relative abundance indices for elk, moose, and white-tailed deer,
  #'  in addition to basic habitat variables (elevation and percent forest cover), year,
  #'  and camera setup on first-order psi. Elk, moose, and white-tailed deer
