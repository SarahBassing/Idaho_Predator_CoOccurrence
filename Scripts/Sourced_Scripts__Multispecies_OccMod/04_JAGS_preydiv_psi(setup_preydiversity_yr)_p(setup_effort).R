  ...
  cat(file = './Outputs/04_JAGS_preydiv_psi(setup_preydiversity_yr)_p(setup_effort).txt', "
      model{
        ...
        for(i in 1:nsites) {
          ...
          #'  Covariate indices: Spp1 & Spp2 = Intercept[1] + Setup[2] + Year[5] + Elevation[3] + Forest[4] + SppDiversity[6] 
