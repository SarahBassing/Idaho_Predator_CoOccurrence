  ...
  #'  addition to basic habitat variables (elevation and percent forest cover), year,
  ...
  cat(file = './Outputs/03.3_JAGS_preyabund_psi(setup_preyabund_yr)_p(setup_effort)_bearlion.txt', "
      model{
