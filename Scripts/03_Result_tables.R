  ...
  #'  ---------------------------------------------
  #'  Script to generate result tables that summarize input data and report
  #'  model outputs.Requires sourcing Format_data_multispp_occupancy.R script.
  #'  ---------------------------------
  ...
  #'  Call data formatting script to load covariates and detection histories
  ...
  DH_bear <- all_detections(DetectionHist_Smr20[[1]], DetectionHist_Smr21[[1]], spp = "Black bear")
  DH_bob <- all_detections(DetectionHist_Smr20[[2]], DetectionHist_Smr21[[2]], spp = "Bobcat")
  DH_coy <- all_detections(DetectionHist_Smr20[[3]], DetectionHist_Smr21[[3]], spp = "Coyote")
  DH_lion <- all_detections(DetectionHist_Smr20[[4]], DetectionHist_Smr21[[4]], spp = "Mountain lion")
  DH_wolf <- all_detections(DetectionHist_Smr20[[5]], DetectionHist_Smr21[[5]], spp = "Wolf")
  ...
  #'  Save!
  # write.csv(DH_summary, "./Outputs/Summary_table_DH.csv")
  ...
  #'  ----------------------------------
  #'  Extract outputs for each sub-model and append species info
  rounddig <- 2
  ...
  #' write.csv(top_null_results, file = "./Outputs/top_null_results.csv")
  #' write.csv(top_non_null_results, file = "./Outputs/top_non_null_results.csv")
  #' write.csv(top_occmod_table_long, file = "./Outputs/top_occmod_table_long.csv")
  #' write.csv(top_occmod_table_wide, file = "./Outputs/top_occmod_table_wide.csv")
  #' write.csv(top_occmod_table, file = "./Outputs/top_occmod_table.csv")
  ...
  #' write.csv(top_detmod_table_long, file = "./Outputs/top_detmod_table_long.csv")
  #' write.csv(top_detmod_table_wide, file = "./Outputs/top_detmod_table_wide.csv")
  #' write.csv(co_detmod_table_long, file = "./Outputs/co_detmod_table_long.csv")
  #' write.csv(co_detmod_table_wide, file = "./Outputs/co_detmod_table_wide.csv")
